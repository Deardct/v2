...
const args = {
	jdNotify: false,
	pageSize: 12,
	//cidsList: ["家用电器", "手机数码", "电脑办公", "家居家装","更多惊喜","美妆护肤","钟表奢品"],
	cidsList: ["家用电器", "手机数码", "电脑办公","更多惊喜","钟表奢品","服饰鞋包","家居家装","生鲜美食","食品饮料"],
	typeList: ["普通试用", "闪电试用"],
	goodFilters: "教程@啤酒@延时@爸爸@宠物@老爷@茶@酒@钢化膜@同仁堂@儿童@糖果@孕妇@喷雾@阳具@软件@英语@辅导@培训@手机壳@玉@婴儿@母@拐杖@手机膜@牙刷@电信卡@联通@移动@布湿@贴@益生菌@面包@避孕套".split('@'),
	minPrice: 50,
	maxSupplyCount: 10,
}
